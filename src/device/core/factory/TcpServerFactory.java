...
import device.core.dispatcher.TcpServerDispatcher;

import java.net.InetAddress;
import java.net.UnknownHostException;

public class TcpServerFactory implements CommFactory {
    @Override
    ...
    public CommDispatcher create(String commAddress) {
        String[] parts = commAddress.split(":");
        return new TcpServerDispatcher(new TcpServerChannel(0, parts[0], Integer.parseInt(parts[1])));
    }
}
